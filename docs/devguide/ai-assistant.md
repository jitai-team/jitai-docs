...
**恢复流程**：在工作区订阅这个节点的暂停事件，进行相关处理逻辑后调用[发送AI消息](#send-ai-message)函数就能恢复流程。发送的消息内容会作为节点的输出参数存储到运行状态数据中，供其他节点使用。 
### 函数调用 {#function-call}
...
## 使用指南 {#usage-guide}
### 哪些地方可使用AI助理
- [门户中使用AI助理](portal-and-page-development/portal-navigation-design#integrate-ai-assistant-in-portals)
- [常规页面中使用AI助理](portal-and-page-development/component-based-page-development#integrate-ai-assistant-in-pages)
...
配置方式参考：[门户中使用AI助理](portal-and-page-development/portal-navigation-design#integrate-ai-assistant-in-portals)、[常规页面中使用AI助理](portal-and-page-development/component-based-page-development#integrate-ai-assistant-in-pages)
