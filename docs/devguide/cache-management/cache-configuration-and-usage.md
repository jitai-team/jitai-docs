---
sidebar_position: 1
slug: cache-configuration-and-usage
---
...
弹出参数配置面板，按提示填写连接信息并保存。生产环境建议将连接参数通过环境变量注入，避免把密码等敏感信息写入仓库，参考：[数据库连接安全配置](../data-modeling/manage-database-connections#数据库连接安全配置)。
...
[Redis缓存](../../reference/framework/JitStorage/cache/redis-cache#方法)

[SQLite缓存](../../reference/framework/JitStorage/cache/sqlite-cache#方法)

[TongRDS缓存](../../reference/framework/JitStorage/cache/tongrds-cache#方法)
