...
![Append Merge](./img/append-merge.png "Append Merge")
...
![Horizontal Join](./img/horizontal-join.png "Horizontal Join")
...
![Group Aggregation](./img/group-aggregation.png "Group Aggregation")
...
![Date Grouping](./img/date-grouping.png "Date Grouping")
...
![Address Grouping](./img/address-grouping.png "Address Grouping")
