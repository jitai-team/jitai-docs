...
>
  <LinkGrid links={[
    { text: "什么是开发者组织", href: "应用开发基础/开发者组织管理#什么是开发者组织" },
    { text: "在激活节点时创建新的开发组织", href: "应用开发基础/开发者组织管理#在激活节点时创建新的开发组织" },
    { text: "在激活节点时将节点绑定到自己已加入的组织", href: "应用开发基础/开发者组织管理#在激活节点时将节点绑定到自己已加入的组织" },
    { text: "在激活节点时使用组织绑定码加入组织并绑定", href: "应用开发基础/开发者组织管理#在激活节点时使用组织绑定码加入组织并绑定" },
    { text: "在登录已有节点时通过组织绑定码加入组织", href: "应用开发基础/开发者组织管理#在登录已有节点时通过组织绑定码加入组织" },
    { text: "查看和刷新组织绑定码", href: "应用开发基础/开发者组织管理#查看和刷新组织绑定码" },
    { text: "移除组织成员", href: "应用开发基础/开发者组织管理#移除组织成员" }
  ]} />
</IndexCard>
...
>
  <LinkGrid links={[
    { text: "什么是运行环境", href: "应用开发基础/运行环境管理#什么是运行环境" },
    { text: "节点的本地默认运行环境", href: "应用开发基础/运行环境管理#节点的本地默认运行环境" },
    { text: "创建新的运行环境", href: "应用开发基础/运行环境管理#创建新的运行环境" },
    { text: "使用运行环境管理节点集群", href: "应用开发基础/运行环境管理#使用运行环境管理节点集群" },
    { text: "在运行环境中部署应用", href: "应用开发基础/运行环境管理#在运行环境中部署应用" }
  ]} />
</IndexCard>
...
<IndexCard>
  <LinkGrid links={[
    { text: "元素目录树", href: "JitAi可视化开发工具#元素目录树" },
    { text: "添加元素", href: "JitAi可视化开发工具#添加元素" },
    { text: "可视化编辑器", href: "JitAi可视化开发工具#可视化编辑器" },
    { text: "源码编辑器", href: "JitAi可视化开发工具#源码编辑器" },
    { text: "源码文件树", href: "JitAi可视化开发工具#源码文件树" },
    { text: "应用设置", href: "JitAi可视化开发工具#应用设置" },
    { text: "门户切换", href: "JitAi可视化开发工具#门户切换" },
    { text: "个人中心", href: "JitAi可视化开发工具#个人中心" },
    { text: "语言切换", href: "JitAi可视化开发工具#语言切换" },
    { text: "导航标签", href: "JitAi可视化开发工具#导航标签" }
  ]} />
</IndexCard>
...
>
  <LinkGrid links={[
    { text: "应用内置3个门户", href: "门户与页面开发/门户导航设计#应用内置3个门户" },
    { text: "3种门户类型", href: "门户与页面开发/门户导航设计#3种门户类型" },
    { text: "创建门户并配置菜单", href: "门户与页面开发/门户导航设计#创建门户并配置菜单" },
    { text: "门户布局设计", href: "门户与页面开发/门户导航设计#门户布局设计" },
    { text: "启用或关闭常用功能入口", href: "门户与页面开发/门户导航设计#启用或关闭常用功能入口" },
    { text: "在门户中集成AI助理", href: "门户与页面开发/门户导航设计#在门户中集成ai助理" }
  ]} />
</IndexCard>

<IndexCard
  title="组件化页面开发"
  href="门户与页面开发/组件化页面开发"
  description="使用可视化编辑器构建页面界面，配置组件和事件，实现丰富的用户交互功能。"
>
  <LinkGrid links={[
    { text: "创建一个常规页面", href: "门户与页面开发/组件化页面开发#创建一个常规页面" },
    { text: "可视化页面编辑器", href: "门户与页面开发/组件化页面开发#可视化页面编辑器" },
    { text: "页面变量", href: "门户与页面开发/组件化页面开发#页面变量" },
    { text: "页面事件", href: "门户与页面开发/组件化页面开发#页面事件" },
    { text: "页面函数", href: "门户与页面开发/组件化页面开发#页面函数" }
  ]} />
</IndexCard>

<IndexCard
  title="AI数据管理页面"
  href="门户与页面开发/AI数据管理页面"
  description="AI加持的AI数据管理页面，智能辅助高效完成数据浏览、筛选、编辑与批量操作。"
>
  <LinkGrid columns={2} links={[
    { text: "创建AI数据管理页面", href: "门户与页面开发/AI数据管理页面#创建ai数据管理页面" },
    { text: "通过默认筛选条件限制页面表格查询的数据", href: "门户与页面开发/AI数据管理页面#通过默认筛选条件限制页面表格查询的数据" },
    { text: "配置默认的数据排序规则", href: "门户与页面开发/AI数据管理页面#配置默认的数据排序规则" },
    { text: "在页面表格中隐藏部分字段", href: "门户与页面开发/AI数据管理页面#在页面表格中隐藏部分字段" },
    { text: "配置支持条件筛选的字段", href: "门户与页面开发/AI数据管理页面#配置支持条件筛选的字段" },
    { text: "配置表单中允许查看和编辑的字段", href: "门户与页面开发/AI数据管理页面#配置表单中允许查看和编辑的字段" },
    { text: "配置批量编辑表单中展示的字段", href: "门户与页面开发/AI数据管理页面#配置批量编辑表单中展示的字段" },
    { text: "启用AI数据管理助手", href: "门户与页面开发/AI数据管理页面#启用-ai-数据管理助手" },
    { text: "转换为常规页面进行修改", href: "门户与页面开发/AI数据管理页面#转换为常规页面进行修改" }
  ]} />
</IndexCard>

<IndexCard
  title="AI数据分析页面"
  href="门户与页面开发/AI数据分析页面"
  description="通过自然语言描述需求，AI自动生成数据图表，支持用户随时调整图表样式和统计维度。"
>
  <LinkGrid links={[
    { text: "创建AI数据分析页面", href: "门户与页面开发/AI数据分析页面#创建ai数据分析页面" },
    { text: "页面配置", href: "门户与页面开发/AI数据分析页面#页面配置" },
    { text: "运行效果演示", href: "门户与页面开发/AI数据分析页面#运行效果" },
    { text: "全代码开发", href: "门户与页面开发/AI数据分析页面#全代码开发" },
    { text: "快捷创建", href: "门户与页面开发/AI数据分析页面#快捷创建" }
  ]} />
</IndexCard>
...
>
  <LinkGrid links={[
    { text: "创建数据录入页面", href: "门户与页面开发/数据录入页面#创建数据录入页面" },
    { text: "配置允许查看和编辑的字段", href: "门户与页面开发/数据录入页面#配置允许查看和编辑的字段" },
    { text: "提交后显示再次录入按钮", href: "门户与页面开发/数据录入页面#提交后显示再次录入按钮" },
    { text: "提交后展示结果反馈界面", href: "门户与页面开发/数据录入页面#提交后展示结果反馈界面" }
  ]} />
</IndexCard>
...
<IndexCard
  title="Markdown页面"
  href="门户与页面开发/Markdown页面"
  description="创建文档型页面，支持丰富的Markdown语法和文档展示需求。"
>
  <LinkGrid links={[
    { text: "创建 Markdown 页面", href: "门户与页面开发/Markdown页面#创建-markdown-页面" },
    { text: "Markdown 语法", href: "门户与页面开发/Markdown页面#markdown-语法" }
  ]} />
</IndexCard>
...
<IndexCard
  title="全代码页面开发"
  href="门户与页面开发/全代码页面开发"
  description="面向高级开发者的完全自定义页面开发方式，支持复杂业务逻辑和个性化界面。"
>
  <LinkGrid columns={2} links={[
    { text: "React 全代码页面", href: "门户与页面开发/全代码页面开发#react-全代码页面" },
    { text: "创建 React 全代码页面", href: "门户与页面开发/全代码页面开发#创建-react-全代码页面" },
    { text: "使用样式", href: "门户与页面开发/全代码页面开发#使用样式" },
    { text: "使用本地资源", href: "门户与页面开发/全代码页面开发#使用本地资源" },
    { text: "使用 Ant Design 的组件", href: "门户与页面开发/全代码页面开发#使用-ant-design-的组件" },
    { text: "内嵌已有常规页面", href: "门户与页面开发/全代码页面开发#内嵌已有常规页面" },
    { text: "使用标准组件", href: "门户与页面开发/全代码页面开发#使用标准组件" },
    { text: "调用数据模型函数", href: "门户与页面开发/全代码页面开发#调用数据模型函数" },
    { text: "调用服务函数", href: "门户与页面开发/全代码页面开发#调用服务函数" },
    { text: "Vue全代码页面", href: "门户与页面开发/全代码页面开发#vue全代码页面" },
    { text: "使用第三方包", href: "门户与页面开发/全代码页面开发#使用第三方包" },
    { text: "打包配置的使用", href: "门户与页面开发/全代码页面开发#打包配置的使用" }
  ]} />
</IndexCard>
...
>
  <LinkGrid columns={2} links={[
    { text: "配置列表标题", href: "在页面中使用功能组件/列表组件#配置列表标题" },
    { text: "设置摘要内容", href: "在页面中使用功能组件/列表组件#设置摘要内容" },
    { text: "摘要中显示字段标题", href: "在页面中使用功能组件/列表组件#摘要中显示字段标题" },
    { text: "设置摘要内容布局", href: "在页面中使用功能组件/列表组件#设置摘要内容布局" },
    { text: "列表组件按钮", href: "在页面中使用功能组件/列表组件#列表组件按钮" },
    { text: "添加按钮", href: "在页面中使用功能组件/列表组件#添加按钮" },
    { text: "修改按钮属性", href: "在页面中使用功能组件/列表组件#修改按钮属性" },
    { text: "按钮收起到更多", href: "在页面中使用功能组件/列表组件#按钮收起到更多" },
    { text: "按钮拖拽排序", href: "在页面中使用功能组件/列表组件#按钮拖拽排序" },
    { text: "设置底部按钮大小", href: "在页面中使用功能组件/列表组件#设置底部按钮大小" },
    { text: "首次加载组件时刷新数据", href: "在页面中使用功能组件/列表组件#首次加载组件时刷新数据" },
    { text: "是否启用点击行事件", href: "在页面中使用功能组件/列表组件#是否启用点击行事件" },
    { text: "默认选中第一条数据", href: "在页面中使用功能组件/列表组件#默认选中第一条数据" },
    { text: "显示行间距", href: "在页面中使用功能组件/列表组件#显示行间距" },
    { text: "列表组件事件", href: "在页面中使用功能组件/列表组件#列表组件事件" },
    { text: "点击行事件", href: "在页面中使用功能组件/列表组件#点击行事件" },
    { text: "按钮事件", href: "在页面中使用功能组件/列表组件#按钮事件" },
    { text: "列表组件变量", href: "在页面中使用功能组件/列表组件#列表组件变量当前展示的数据行列表当前操作的单行数据当前筛选条件" },
    { text: "刷新列表组件", href: "在页面中使用功能组件/列表组件#刷新列表组件" }
  ]} />
</IndexCard>
...
<IndexCard>
  <LinkGrid links={[
    { text: "主流大模型厂商支持列表", href: "AI大模型#主流大模型厂商支持列表" },
    { text: "大模型厂商元素的创建", href: "AI大模型#大模型厂商元素的创建" },
    { text: "重试及备用API Key机制", href: "AI大模型#重试及备用api-key机制" },
    { text: "私有化大模型集成", href: "AI大模型#私有化大模型集成" },
    { text: "在页面中调用大模型", href: "AI大模型#在页面中调用大模型" },
    { text: "在后端函数中调用大模型", href: "AI大模型#在后端函数中调用大模型" },
    { text: "大模型编程接口", href: "AI大模型#大模型编程接口" }
  ]} />
</IndexCard>
...
<IndexCard>
  <LinkGrid links={[
    { text: "Chroma向量数据库", href: "向量数据库#chroma向量数据库" },
    { text: "本地向量数据库配置", href: "向量数据库#本地向量数据库配置" },
    { text: "远程向量数据库连接", href: "向量数据库#远程向量数据库连接" },
    { text: "向量数据库编程接口", href: "向量数据库#向量数据库编程接口" }
  ]} />
</IndexCard>
...
<IndexCard>
  <LinkGrid columns={2} links={[
    { text: "创建AI知识库元素", href: "AI知识库#创建ai知识库元素" },
    { text: "AI知识库的管理", href: "AI知识库#ai知识库的管理" },
    { text: "文档管理", href: "AI知识库#文档管理" },
    { text: "AI知识库设置", href: "AI知识库#ai知识库设置" },
    { text: "查询测试", href: "AI知识库#查询测试" },
    { text: "在后端可视化编程中调用AI知识库", href: "AI知识库#在后端可视化编程中调用ai知识库" },
    { text: "在AIAgent中使用AI知识库", href: "AI知识库#在aiagent中使用ai知识库" },
    { text: "AI知识库编程接口", href: "AI知识库#ai知识库编程接口" },
    { text: "原理及参数说明", href: "AI知识库#原理及参数说明" },
    { text: "向量化配置说明", href: "AI知识库#向量化配置说明" }
  ]} />
</IndexCard>
...
<IndexCard>
  <LinkGrid columns={2} links={[
    { text: "创建ReActAgent", href: "AIAgent#创建reactagent" },
    { text: "编写系统提示词", href: "AIAgent#编写系统提示词" },
    { text: "基于模板编写系统提示词", href: "AIAgent#基于模板编写系统提示词" },
    { text: "在提示词中使用变量", href: "AIAgent#在提示词中使用变量" },
    { text: "选择模型并配置参数", href: "AIAgent#选择模型并配置参数" },
    { text: "为Agent编写简介描述", href: "AIAgent#为agent编写简介描述" },
    { text: "配置运行状态存储仓", href: "AIAgent#配置运行状态存储仓" },
    { text: "内存存储", href: "AIAgent#内存存储" },
    { text: "数据库存储", href: "AIAgent#数据库存储" },
    { text: "配置输入变量", href: "AIAgent#配置输入变量" },
    { text: "配置输出结果", href: "AIAgent#配置输出结果" },
    { text: "为Agent添加工具", href: "AIAgent#为agent添加工具" },
    { text: "Agent调用模型函数", href: "AIAgent#agent调用模型函数" },
    { text: "Agent调用服务函数", href: "AIAgent#agent调用服务函数" },
    { text: "Agent调用MCP服务", href: "AIAgent#agent调用mcp服务" },
    { text: "将MCP配置转为环境变量", href: "AIAgent#将mcp配置转为环境变量" },
    { text: "Agent调用外部API", href: "AIAgent#agent调用外部api" },
    { text: "Agent调用页面函数", href: "AIAgent#agent调用页面函数" },
    { text: "启用/关闭工具函数", href: "AIAgent#启用关闭工具函数" },
    { text: "工具函数调用前/后事件触发", href: "AIAgent#工具函数调用前后事件触发" },
    { text: "工具函数执行前的人工确认", href: "AIAgent#工具函数执行前的人工确认" },
    { text: "限制工具函数调用的用户角色", href: "AIAgent#限制工具函数调用的用户角色" },
    { text: "集成知识库实现检索增强生成（RAG）", href: "AIAgent#集成知识库实现检索增强生成rag" },
    { text: "在前端函数中调用Agent", href: "AIAgent#在前端函数中调用agent" },
    { text: "在页面助理中测试Agent", href: "AIAgent#在页面助理中测试agent" },
    { text: "在后端服务函数中调用Agent", href: "AIAgent#在后端服务函数中调用agent" },
    { text: "源码模式修改Agent", href: "AIAgent#源码模式修改agent" },
    { text: "自定义回调处理器", href: "AIAgent#自定义回调处理器" },
    { text: "Agent的流式输出", href: "AIAgent#agent的流式输出" }
  ]} />
</IndexCard>
...
<IndexCard>
  <LinkGrid columns={2} links={[
    { text: "什么是AI助理", href: "AI助理#什么是ai助理" },
    { text: "创建AI助理", href: "AI助理#创建ai助理" },
    { text: "可视化编排", href: "AI助理#可视化编排" },
    { text: "开始节点", href: "AI助理#开始节点" },
    { text: "路由决策", href: "AI助理#路由决策" },
    { text: "AIAgent", href: "AI助理#aiagent" },
    { text: "对话区人机交互", href: "AI助理#对话区人机交互" },
    { text: "工作区人机交互", href: "AI助理#工作区人机交互" },
    { text: "函数调用", href: "AI助理#函数调用" },
    { text: "条件分支", href: "AI助理#条件分支" },
    { text: "多任务执行", href: "AI助理#多任务执行" },
    { text: "事件类型概览", href: "AI助理#事件类型概览" },
    { text: "前端工作区事件", href: "AI助理#前端工作区事件" },
    { text: "后端业务事件", href: "AI助理#后端业务事件" },
    { text: "运行状态数据", href: "AI助理#运行状态数据" },
    { text: "运行状态存储库", href: "AI助理#运行状态存储库" },
    { text: "高级设置", href: "AI助理#高级设置" },
    { text: "使用指南", href: "AI助理#使用指南" },
    { text: "欢迎语与开场白", href: "AI助理#欢迎语与开场白" },
    { text: "消息输出", href: "AI助理#消息输出" },
    { text: "发送AI消息", href: "AI助理#发送ai消息" },
    { text: "对话记录管理", href: "AI助理#对话记录管理" },
    { text: "全代码开发", href: "AI助理#全代码开发" },
    { text: "示例演示", href: "AI助理#示例演示" },
    { text: "如何选择合适的节点类型？", href: "AI助理#如何选择合适的节点类型" },
    { text: "流程卡住常见原因和解决方法", href: "AI助理#流程卡住常见原因和解决方法" }
  ]} />
</IndexCard>
...
>
  <LinkGrid columns={2} links={[
    { text: "扩展表创建", href: "数据建模/扩展表模型#扩展表创建" },
    { text: "连接设计", href: "数据建模/扩展表模型#连接设计" },
    { text: "设置基准表筛选条件", href: "数据建模/扩展表模型#设置基准表筛选条件" },
    { text: "添加数据表", href: "数据建模/扩展表模型#添加数据表" },
    { text: "实时编辑统计表配置", href: "数据建模/扩展表模型#实时编辑统计表配置" },
    { text: "字段统计", href: "数据建模/扩展表模型#字段统计" },
    { text: "添加公式字段", href: "数据建模/扩展表模型#添加公式字段" },
    { text: "修改字段别名", href: "数据建模/扩展表模型#修改字段别名" },
    { text: "函数设计", href: "数据建模/扩展表模型#函数设计" },
    { text: "新建函数", href: "数据建模/扩展表模型#新建函数" },
    { text: "源码查看编辑", href: "数据建模/扩展表模型#源码查看编辑" }
  ]} />
</IndexCard>
...
>
  <LinkGrid links={[
    { text: "数据对象模型创建", href: "数据建模/数据对象模型#数据对象模型创建" },
    { text: "数据对象模型使用", href: "数据建模/数据对象模型#数据对象模型使用" },
    { text: "自定义字段", href: "数据建模/数据对象模型#自定义字段" },
    { text: "模型函数重写", href: "数据建模/数据对象模型#模型函数重写" },
    { text: "定义新函数", href: "数据建模/数据对象模型#定义新函数" }
  ]} />
</IndexCard>
...
>
  <LinkGrid columns={2} links={[
    ...
    { text: "在开发者门户中管理应用角色成员", href: "用户与权限/角色权限#在开发者门户中管理应用角色成员" },
...
<IndexCard
  title="封装业务服务函数"
  href="业务逻辑开发/封装业务服务函数"
  description="后端业务逻辑实现，通过服务元素封装可复用的业务函数，提供API接口和数据处理服务。"
>
  <LinkGrid columns={2} links={[
    { text: "创建服务元素", href: "业务逻辑开发/封装业务服务函数#创建服务元素" },
    { text: "创建服务函数", href: "业务逻辑开发/封装业务服务函数#创建服务函数" },
    { text: "源码模式编辑服务函数", href: "业务逻辑开发/封装业务服务函数#源码模式编辑服务函数" },
    { text: "添加新的依赖库", href: "业务逻辑开发/封装业务服务函数#添加新的依赖库" },
    { text: "服务函数在哪里使用", href: "业务逻辑开发/封装业务服务函数#服务函数在哪里使用" },
    { text: "让AI更准确地理解服务函数", href: "业务逻辑开发/封装业务服务函数#让ai更准确地理解服务函数" },
    { text: "使用跨App服务元素调用授权接口", href: "业务逻辑开发/封装业务服务函数#使用跨app服务元素调用授权接口" },
    { text: "创建跨App服务元素", href: "业务逻辑开发/封装业务服务函数#创建跨app服务元素" },
    { text: "在函数逻辑中使用跨App服务元素", href: "业务逻辑开发/封装业务服务函数#在函数逻辑中使用跨app服务元素" }
  ]} />
</IndexCard>
...
>
  <LinkGrid links={[
    ...
    { text: "使用SDK调用授权的接口", href: "API开放/API授权#使用sdk调用授权的接口" },
    { text: "使用跨App服务元素调用授权接口", href: "API开放/API授权#使用跨app服务元素调用授权接口" }
  ]} />
</IndexCard>
