...
## 创建data-entry-page
data-entry-page的创建过程和[常规页面的创建过程](./component-based-page-development#创建一个常规页面)基本一致，不同的是data-entry-page需要绑定一个[数据表模型](../data-modeling/data-table-model)，用于存储用户录入的数据。
