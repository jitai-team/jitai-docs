...
组织架构创建完成后，JitAi将自动为该组织配置[钉钉自建扫码登录方式](./login-authentication#钉钉自建扫码登录)，无需手动设置，便于成员通过钉钉扫码快捷登录系统。
...
组织架构创建完成后，JitAi将自动为该组织配置[企业微信自建扫码登录方式](./login-authentication#企业微信自建扫码登录)，无需手动设置，便于成员通过企业微信扫码快捷登录系统。
