...
配置日程类型，可以改变任务背景展示颜色，日程类型对应的字段颜色，在[数据模型配置](../data-modeling/data-table-model#设计表字段与数据类型)中修改。
...
配置颜色类型，可以改变时间轴上节点的颜色，颜色类型对应的字段颜色，在[数据模型配置](../data-modeling/data-table-model#设计表字段与数据类型)中修改。
