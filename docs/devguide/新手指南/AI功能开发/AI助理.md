...
### 开始节点
这是工作流的起点，就像项目的入口一样。它接收用户的输入和其他[自定义的输入参数](#高级设置)，把这些信息存到“记忆”里，然后开始执行任务。
...
在流程中点击路由决策节点，右侧会打开配置窗口；选择[大模型](大模型配置)，配置好参数就完成了。
...
### 哪些地方可使用AI助理
- [门户中使用AI助理](../应用开发基础/门户导航设计#在门户中集成ai助理)
- [标准页面中使用AI助理](../应用开发基础/页面UI与功能开发#在页面中集成ai助理)
...
配置方式参考：[门户中使用AI助理](../应用开发基础/门户导航设计#在门户中集成ai助理)、[标准页面中使用AI助理](../应用开发基础/页面UI与功能开发#在页面中集成ai助理)
