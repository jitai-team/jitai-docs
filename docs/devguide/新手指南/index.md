...
<IndexCard
  ...
  description="快速创建数据录入表单和管理界面，实现常见的数据收集和CRUD操作功能。"
>
  <LinkGrid links={[
    { text: "数据录入页面开发", href: "应用开发基础/配置数据录入与管理页面#数据录入页面开发" },
    { text: "数据管理页面开发", href: "应用开发基础/配置数据录入与管理页面#数据管理页面开发" }
  ]} />
</IndexCard>
...
<IndexCard
  ...
  description="强大的数据筛选工具，支持多条件组合筛选和高级查询功能。"
>
  <LinkGrid links={[
    { text: "模型筛选器", href: "在页面中使用功能组件/筛选器组件#模型筛选器" },
    { text: "简单筛选", href: "在页面中使用功能组件/筛选器组件#简单筛选" },
    { text: "复杂筛选", href: "在页面中使用功能组件/筛选器组件#复杂筛选" },
    { text: "自由筛选", href: "在页面中使用功能组件/筛选器组件#自由筛选" },
    { text: "通用筛选器", href: "在页面中使用功能组件/筛选器组件#通用筛选器" }
  ]} />
</IndexCard>
...
>
  <LinkGrid columns={2} links={[
    { text: "按钮组件的创建", href: "在页面中使用功能组件/按钮组件#按钮组件创建" },
    { text: "按钮组件参数", href: "在页面中使用功能组件/按钮组件#按钮组件参数" },
    { text: "按钮组件事件", href: "在页面中使用功能组件/按钮组件#按钮组件事件" }
  ]} />
</IndexCard>
...
>
  <LinkGrid columns={2} links={[
    ...
    { text: "发起申请组件参数配置", href: "在页面中使用功能组件/审批组件#参数配置" },
    { text: "发起申请组件事件", href: "在页面中使用功能组件/审批组件#事件逻辑" },
    { text: "审批处理组件创建", href: "在页面中使用功能组件/审批组件#创建审批处理组件" },
    { text: "审批处理组件参数", href: "在页面中使用功能组件/审批组件#审批处理组件参数" },
    { text: "审批处理组件事件", href: "在页面中使用功能组件/审批组件#审批处理事件逻辑" }
  ]} />
</IndexCard>
...
>
  <LinkGrid links={[
    ...
    { text: "自定义控件的实现", href: "样式与控件定制/自定义控件#自定义控件的实现" }
  ]} />
</IndexCard>
