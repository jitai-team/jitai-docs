...
[Redis缓存](../../reference/开发框架/JitStorage/缓存/Redis缓存.md#方法)

[SQLite缓存](../../reference/开发框架/JitStorage/缓存/SQLite缓存.md#方法)

[TongRDS缓存](../../reference/开发框架/JitStorage/缓存/TongRDS缓存.md#方法)
