...
- [AI智能出题，智能阅卷](../tutorial/AI出题阅卷.md) - AI教育应用案例
...
- [Agent提示词编写技巧](../devguide/Agent提示词编写技巧.md) - 高质量提示词的可执行写法与校验清单
...
- [对外开放API接口](../devguide/应用场景/对外开放API接口)
- [集成外部API接口](../devguide/应用场景/集成外部API接口)
- [使用拦截器实现自定义请求鉴权](../devguide/应用场景/使用拦截器实现自定义请求鉴权)
- [自定义业务事件的触发订阅与处理](../devguide/应用场景/自定义业务事件的触发订阅与处理)
- [在线支付功能集成](../devguide/应用场景/在线支付功能集成)
- [定时执行自定义业务逻辑](../devguide/应用场景/定时执行自定义业务逻辑)
- [使用数据库表的时间字段触发定时任务](../devguide/应用场景/使用数据库表的时间字段触发定时任务)
