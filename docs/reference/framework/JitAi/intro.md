...
**[JAAP（Jit AI Application Protocol）](../../runtime-platform/JAAP)** 从结构定义和过程驱动两个维度，定义了AI原生的企业级应用架构，满足AI应用开发范式。
