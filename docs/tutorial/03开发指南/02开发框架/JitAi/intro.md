...
:::tip 前瞻技术实践
JitAi在AGUI概念出现之前就已完成AI驱动前端的实践，实现了智能体对UI界面的直接操作能力，这是企业级AI应用的重要技术突破。
:::
...
<Tabs>
<TabItem value="self-description" label="元素自描述能力" default>
...
<TabItem value="dynamic-loading" label="动态按需加载">
...
<TabItem value="native-integration" label="原生AI集成">
...
**技术领先性**：
- JitAi在AGUI概念出现之前就已实现了AI调用前端的能力
