...
本文档将指导您如何在本地环境中配置 JitNode 的开发调试环境，以便进行高效的代码开发和问题排查。

## 🛠️ 环境准备

:::info 
确保您已经完成了 JitNode 的基础安装和配置。如果还未安装，请参考 [下载安装](../00快速上手/01下载安装.md) 章节。

关于DevOps最佳实践，请参考[运维架构与管理指南](../03开发指南/03运维管理/01运维架构与管理指南.md)。
:::

JitNode 支持多种主流IDE进行本地开发调试，您可以根据个人偏好选择：
