...
1. <a href="https://apk.jit.pro/latest/windows/JitAI.exe" className="analytics-downloadWindows">Download the installer</a>
...
1. Download the appropriate installer: <a href="https://apk.jit.pro/latest/darwin/arm/JitAI.dmg" className="analytics-downloadMac analytics-downloadMacApple">Apple Silicon Macs</a> or <a href="https://apk.jit.pro/latest/darwin/x64/JitAI.dmg" className="analytics-downloadMac analytics-downloadMacIntel">Intel-based Macs</a> 
