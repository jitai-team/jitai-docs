...
description="学习如何集成主流大语言模型，配置 API 密钥，实现重试机制，并在应用中调用大模型函数。"
...
<IndexCard
title="使用大模型函数实现多模态 AIGC"
href="devguide/ai-llm/implement-multimodal-aigc"
description="探索如何利用大模型函数创建包含文本、图像等多种媒体类型的多模态 AI 生成内容。"
...
description="学习如何创建 AI 知识库元素，并了解其工作原理。"
...
description="在 Agent 中集成知识库实现 RAG。"
...
> <LinkGrid links={[
    ...
    { text: "配置子Agent", href: "devguide/ai-agent/create-deep-agent#配置子agent" },
...
> <LinkGrid links={[
    ...
    { text: "配置知识库", href: "devguide/ai-agent/agent-knowledge-base#配置知识库" }
...
> <LinkGrid links={[
    ...
    { text: "需求建模 Agent", href: "devguide/ai-agent/agent-built-in#需求建模-agent" },
    { text: "表建模 Agent", href: "devguide/ai-agent/agent-built-in#表建模-agent" },
    { text: "数据操作 Agent", href: "devguide/ai-agent/agent-built-in#数据操作-agent" },
    { text: "数据分析 Agent", href: "devguide/ai-agent/agent-built-in#数据分析-agent" },
    { text: "如何使用", href: "devguide/ai-agent/agent-built-in#如何使用" }
...
<IndexCard
title="创建一个可被 Agent 复用的标准 Skill"
...
<IndexCard
title="写出 Agent 能稳定执行的 Skill 内容"
href="devguide/skills/write-skill-content"
description="学习如何编写适用场景、能力范围、执行步骤、输出格式和约束条件，让 Agent 更稳定地使用 Skill。"

> <LinkGrid links={[

    { text: "先写清楚 Skill 适用场景", href: "devguide/skills/write-skill-content#write-applicable-scenarios-first" },
    { text: "用能力范围限定边界", href: "devguide/skills/write-skill-content#define-capability-scope" },
    { text: "用执行步骤沉淀操作流程", href: "devguide/skills/write-skill-content#write-execution-steps" },
    { text: "用输出格式稳定结果", href: "devguide/skills/write-skill-content#stabilize-output-format" },
    { text: "用约束条件减少误用", href: "devguide/skills/write-skill-content#add-constraints" }

]} />
</IndexCard>

<IndexCard
title="用附件管理复杂规则、模板和示例"
...
<IndexCard
title="设计可长期复用的高质量 Skill"
href="devguide/skills/skill-best-practices"
description="掌握 Skill 的设计原则：边界清晰、描述具体、职责不冲突、输出可检查、复杂知识拆附件。"

> <LinkGrid links={[

    { text: "一个 Skill 只解决一类问题", href: "devguide/skills/skill-best-practices#one-skill-one-problem" },
    { text: "描述要让 Agent 能判断是否适用", href: "devguide/skills/skill-best-practices#description-should-guide-selection" },
    { text: "不要和 Agent 主提示词重复职责", href: "devguide/skills/skill-best-practices#avoid-overlap-with-agent-prompts" },
    { text: "输出格式要可检查", href: "devguide/skills/skill-best-practices#make-output-checkable" },
    { text: "不要把知识库内容搬进 Skill", href: "devguide/skills/skill-best-practices#do-not-copy-knowledge-base" }
