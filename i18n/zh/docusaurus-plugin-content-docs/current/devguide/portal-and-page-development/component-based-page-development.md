---
sidebar_position: 2
slug: component-based-page-development
---

# 组件化页面开发
页面是用户与应用系统交互的主要场所，由不同的前端功能[组件](../../category/在页面中使用功能组件)构成，为用户提供数据展示界面以及交互操作入口。

开发者在[门户导航设计](./portal-navigation-design)中规划每个门户中的导航菜单，而每个菜单项则对应一个页面的PC端和移动端。

## 创建一个常规页面 {#create-a-regular-page}
...
![创建页面时选择类型](./img/page/create-regular-page.gif)
...
![页面编辑器总体布局](./img/page/page-editor-overall-layout.png)

页面编辑器总体布局分为四个区域：工具栏、画布、组件配置面板、事件面板。

JitAi开发框架提供了丰富的组件库，每种组件的配置项和事件各有不同，开发者可以参考[在页面中使用功能组件](../../category/在页面中使用功能组件)，了解每种组件详细用法。
...
![页面添加组件](./img/page/page-add-component.gif)

开发者点击工具栏最左侧的`+ 插入组件`按钮，在弹窗中找到所需组件（支持搜索），按住鼠标左键将组件拖拽到画布中。画布中可以放置多个组件，通过拖拽调整组件相对位置、组件尺寸大小。

![组件在画布中的通用操作](./img/page/component-common-operations-on-canvas.png)
...
![表格组件配置总览](./img/page/table-component-config-overview.png)
...
![生成副本](./img/page/generate-copy.gif)
...
![标题显隐](./img/page/title-show-hide.gif)
...
![设置组件尺寸](./img/page/set-component-size.gif)
...
![复制和粘贴配置](./img/page/copy-and-paste-configuration.gif)
...
![组件移动](./img/page/move-component-to-other-layout-component.gif)

开发者点击组件右上角的`...`按钮，在弹出的菜单中点击`移动`按钮，在弹窗中选择目标布局组件，即可完成移动。

### 从页面中删除
![删除组件](./img/page/delete-component.gif)
...
![页面变量声明](./img/page/page-variable-declaration.gif)
...
![声明页面函数](./img/page/declare-page-function.gif)
...
![页面函数的更多操作按钮](./img/page/page-function-more-operation-buttons.gif)
...
![页面函数调用](./img/page/page-function-and-variable-call.gif)
...
![页面加载后事件](./img/page/page-after-load-event.gif)
...
![页面聚焦后事件](./img/page/page-focus-after-event.png)
...
![变量值改变后事件](./img/page/variable-value-change-after-event.png)
...
![在事件逻辑中使用页面变量和函数](./img/page/use-page-variables-and-functions-in-event-logic.png)
...
![页面函数清空语句](./img/page/page-function-clear-statements.gif)
...
![复制语句](./img/page/copy-statement.gif)
...
![拖拽移动函数语句](./img/page/drag-move-function-statement.gif)
...
![删除语句](./img/page/delete-statement.gif)
...
![切换并定位语句源代码](./img/page/switch-to-function-statement-source-view.gif)
...
![页面函数编辑快捷键](./img/page/page-function-edit-shortcuts.gif)
...
![页面函数中调用前后端工具和服务](./img/page/call-frontend-backend-tools-services-in-page-function.gif)
...
![函数中调用模型](./img/page/call-model-in-function.png)
...
![函数中调用前端服务](./img/page/call-frontend-service-in-function.png)
...
![创建移动端页面](./img/page/create-mobile-page.png)

开发者在创建页面时可以选择页面的终端类型为`移动端`（默认是PC端）。

![移动端页面编辑器](./img/page/mobile-page-editor.png)
...
![在页面中添加ai-assistant](./img/page/add-ai-assistant-to-page.gif)
