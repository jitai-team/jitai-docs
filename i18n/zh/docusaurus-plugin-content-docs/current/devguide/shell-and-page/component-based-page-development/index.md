...
JitAi支持在页面中直接集成[AI助理](../../ai-assitant/create-ai-assistant)，用户在访问页面时可以与AI助理进行交互。

![在页面中添加AI助理](./imgs/add-ai-assistant-to-page.gif)

开发者在页面编辑器顶部打开`AI助理`开关，在弹出的列表中选择一个[AI助理](../../ai-assitant/create-ai-assistant)，即可在页面中集成AI助理。
