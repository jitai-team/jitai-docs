...
## 在门户中集成AI Agent {#integrating-ai-assistants}
JitAI支持在门户中直接集成[AI Agent](/docs/devguide/ai-agent)，用户在访问门户时可以与AI Agent进行交互。这里做概括性介绍，详细内容请参考[在页面中使用AI元素](/docs/devguide/using-ai-in-portals-and-pages/using-ai-elements-in-pages)。

![门户集成AI Agent](./imgs/portal-integrate-ai-assistant.gif)

开发者在门户配置界面中点击`AI`页签，在配置界面中打开开关并选择一个[AI Agent](/docs/devguide/ai-agent)，即可在门户中集成AI Agent。

![AI Agent在门户中的效果](./imgs/ai-assistant-effect-in-portal.png)

当用户访问开启了[AI Agent](/docs/devguide/ai-agent)的门户时，可以看到"AI Agent"导航菜单，点击即可打开AI Agent对话框并与其对话。
