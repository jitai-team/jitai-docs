...
默认情况下，表单会展示该模型中的所有字段。当然，你也可以根据需求在页面右侧配置面板中的“显示字段”模块进行配置。
...
### 配置项配置设计 {#configuration-item-design}
...
### 录入/查看/编辑模式 {#inputviewedit-modes}
...
### 字段描述显示 {#field-description-display}
...
### 显示操作记录 {#display-operation-records}

![操作记录](./img/2/form_2025-08-21_19-47-29.png)

勾选后，在页面的右侧将会显示操作记录。

### 显示录入结果反馈 {#display-entry-result-feedback}
