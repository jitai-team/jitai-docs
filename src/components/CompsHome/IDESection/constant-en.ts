const CONTENT = {
    ...
    modulesFootnotePrefix: "JitAI IDE has built-in visual editors for various elements and supports developer ",
    modulesFootnoteLinkText: "extensions",
    ...
    coreFeatures: [
        {
            ...
            video: "https://jit-www.oss-accelerate.aliyuncs.com/en_ide_frame.mp4",
        },
        {
            ...
            video: "https://jit-www.oss-accelerate.aliyuncs.com/en_ide_code.mp4",
        },
        {
            ...
            video: "https://jit-www.oss-accelerate.aliyuncs.com/en_ide_extend.mp4",
        },
    ],
    developmentModules: [
        {
